...
<h5 style="margin-right: 30%;">Información de contacto</h5>
  <li class="nav-item" style="margin-right: 30%;"><i class="fa-solid fa-phone">&nbsp;</i>' . $value["phone_number"] . '</li>
  <li class="nav-item" style="margin-right: 30%;"><i class="fa-solid fa-envelope">&nbsp;</i>' . $value["email"] . '</li>
</ul><br><br>
