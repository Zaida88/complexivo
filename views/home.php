...
foreach ($project as $key => $value) {
    ...
    <div class="col-lg-9 row p-4 m-4 pt-lg-4 pb-lg-2 rounded-5 align-items-center shadow-lg bg-dark">
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-1">
        <h1 class="display-4 fw-bold lh-1 text-white">' . $value["name_project"] . '</h1>
        <p class="lead text-white">'. $value["description_project"] . '</p>
      ...
      <div class="col-lg-4 offset-lg-1 p-0 shadow-lg">
          <img src="' . $value["logo_project"] . '" alt="' . $value["logo_project"] . '" width="100%">
      </div>
    </div>
  </div>
...
<h5 style="margin-right: 30%;">Información de contacto</h5>
  <li class="nav-item" style="margin-right: 30%;"><i class="fa-solid fa-phone">&nbsp;</i>' . $value["phone_number_project"] . '</li>
  <li class="nav-item" style="margin-right: 30%;"><i class="fa-solid fa-envelope">&nbsp;</i>' . $value["email_project"] . '</li>
</ul><br><br>
