<div class="content">
  ...
  <div class="d-flex justify-content-start go">
    <button type=" button" class="btn btn-dark back" idLabels="<?php echo $label["id_label"]; ?>">Regresar</button>
  </div>
...
<script src="assets/js/client/list-exercises-filter.js"></script>